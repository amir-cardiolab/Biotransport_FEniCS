...
def pressure_solve(Resistance_flag, Res_vec_tmp, Res1, Res2, Res3, Res4, Res5, Res6, Res7, Res8, Res9, Res10, Res11, Res12, Res13, Res14, Res15, Res16, Res17, Res18, Res19, Res20, Res21, Res22, Res23, Res24, Res25, Res26, Res27, Res28, Res29, Res30, Res31, tstep, Q,n_normal,facet_domains,mesh,assemble_matrix,u_,dp_, x_, Ap,Ap2, b, p_sol, bcs, **NS_namespace):
    ...
    if (Resistance_flag and tstep>20):
     for i in xrange(31):
     ...
     Res_bc1 =  Res_vec_tmp[0] * flow1
     Res_bc2 =  Res_vec_tmp[1] * flow2
     Res_bc3 =  Res_vec_tmp[2] * flow3
     Res_bc4 =  Res_vec_tmp[3] * flow4
     Res_bc5 =  Res_vec_tmp[4] * flow5
     Res_bc6 =  Res_vec_tmp[5] * flow6
     Res_bc7 =  Res_vec_tmp[6] * flow7
     Res_bc8 =  Res_vec_tmp[7] * flow8
     Res_bc9 =  Res_vec_tmp[8] * flow9
     Res_bc10 =  Res_vec_tmp[9] * flow10
     Res_bc11 =  Res_vec_tmp[10] * flow11
     Res_bc12 =  Res_vec_tmp[11] * flow12
     Res_bc13 =  Res_vec_tmp[12] * flow13
     Res_bc14 =  Res_vec_tmp[13] * flow14
     Res_bc15 =  Res_vec_tmp[14] * flow15
     Res_bc16 =  Res_vec_tmp[15] * flow16
     Res_bc17 =  Res_vec_tmp[16] * flow17
     Res_bc18 =  Res_vec_tmp[17] * flow18
     Res_bc19 =  Res_vec_tmp[18] * flow19
     Res_bc20 =  Res_vec_tmp[19] * flow20
     Res_bc21 =  Res_vec_tmp[20] * flow21
     Res_bc22 =  Res_vec_tmp[21] * flow22
     Res_bc23 =  Res_vec_tmp[22] * flow23
     Res_bc24 =  Res_vec_tmp[23] * flow24
     Res_bc25 =  Res_vec_tmp[24] * flow25
     Res_bc26 =  Res_vec_tmp[25] * flow26
     Res_bc27 =  Res_vec_tmp[26] * flow27
     Res_bc28 =  Res_vec_tmp[27] * flow28
     Res_bc29 =  Res_vec_tmp[28] * flow29
     Res_bc30 =  Res_vec_tmp[29] * flow30
     Res_bc31 =  Res_vec_tmp[30] * flow31
