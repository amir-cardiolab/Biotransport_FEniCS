...
import vul_plaque_5A_2010_LAD_SS_BC
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            Res4 = 1, #resistance at the fourth outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_5A_2010_LAD_SS_BC.time_BC()
    v_IR_array = vul_plaque_5A_2010_LAD_SS_BC.Vel_IR_BC()
