...
def pressure_solve(Resistance_flag, Res1, Res2, Res3, Res4, Res5, Res6, Res7, Res8, Res9, Res10, Res11, Res12, Res13, Res14, Res15, Res16, Res17, Res18, Res19, Res20, Res21, Res22, Res23, Res24, Res25, tstep, Q,n_normal,facet_domains,mesh,assemble_matrix,u_,dp_, x_, Ap,Ap2, b, p_sol, bcs, **NS_namespace):
    ...
    if (tstep % 10 == 0):
        ...
        if MPI.rank(mpi_comm_world()) == 0:
            ...
            print '+++++++++++++++++++++++ Res_bc: total outflow:', flow1 + flow2 + flow3 + flow4 + flow5 + flow6 + flow7 + flow8 + flow9 + flow10 + flow11 + flow12 + flow13 + flow14 + flow15 + flow16 + flow17 + flow18 + flow19 + flow20 + flow21 + flow22 + flow23 + flow24 + flow25
            print '+++++++++++++++++++++++ inlet_bc: inflow:', inflow




    if (Resistance_flag and tstep>1000 and tstep % 10 == 0):
     if MPI.rank(mpi_comm_world()) == 0:
...
#                print 'Res1 has changed!'
     ...
     bcs['p'] = [DirichletBC(Q,  Res_bc1 , facet_domains,3), DirichletBC(Q,  Res_bc2, facet_domains,4), DirichletBC(Q,  Res_bc3, facet_domains,5), DirichletBC(Q,  Res_bc4, facet_domains,6), DirichletBC(Q,  Res_bc5, facet_domains,7), DirichletBC(Q,  Res_bc6, facet_domains,8), DirichletBC(Q,  Res_bc7, facet_domains,9), DirichletBC(Q,  Res_bc8, facet_domains,10), DirichletBC(Q,  Res_bc9, facet_domains,11),\
                 ...
                 DirichletBC(Q,  Res_bc19 , facet_domains,21), DirichletBC(Q,  Res_bc20, facet_domains,22), DirichletBC(Q,  Res_bc21, facet_domains,23), DirichletBC(Q,  Res_bc22, facet_domains,24), DirichletBC(Q,  Res_bc23, facet_domains,25), DirichletBC(Q,  Res_bc24, facet_domains,26), DirichletBC(Q,  Res_bc25, facet_domains,27)]
       #Ap = assemble_matrix(Ap2, bcs['p'])
