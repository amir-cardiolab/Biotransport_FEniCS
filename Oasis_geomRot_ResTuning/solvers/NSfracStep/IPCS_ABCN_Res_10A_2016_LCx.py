...
#                print 'Res1 has changed!'
     ...
     bcs['p'] = [DirichletBC(Q,  Res_bc1 , facet_domains,3), DirichletBC(Q,  Res_bc2, facet_domains,4), DirichletBC(Q,  Res_bc2, facet_domains,5), DirichletBC(Q,  Res_bc2, facet_domains,6), DirichletBC(Q,  Res_bc2, facet_domains,7)]
       #Ap = assemble_matrix(Ap2, bcs['p'])
