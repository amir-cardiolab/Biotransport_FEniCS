...
def setup(u_components,backflow_flag,nonNewtonian_flag, beta_backflow,Resistance_flag,n_normal,facet_domains, u, v, p, q, bcs, les_model, nu, nut_,
    ...
    if(nonNewtonian_flag and backflow_flag):
        ...
        ds = Measure("ds")[facet_domains]
        K = lhs( visc_nu*inner(grad(u), grad(v)) * dx - 2.0*beta_backflow *  inner(v, ( dot(u_,n_normal) - abs( dot(u_,n_normal) ) )/2. * u ) * (ds(3, domain=mesh, subdomain_data=facet_domains) + ds(4, domain=mesh, subdomain_data=facet_domains) + ds(5, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(6, domain=mesh, subdomain_data=facet_domains) + ds(7, domain=mesh, subdomain_data=facet_domains) + ds(8, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(9, domain=mesh, subdomain_data=facet_domains) + ds(10, domain=mesh, subdomain_data=facet_domains) + ds(11, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(12, domain=mesh, subdomain_data=facet_domains) + ds(13, domain=mesh, subdomain_data=facet_domains) + ds(14, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(15, domain=mesh, subdomain_data=facet_domains) + ds(16, domain=mesh, subdomain_data=facet_domains) + ds(17, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(18, domain=mesh, subdomain_data=facet_domains) + ds(19, domain=mesh, subdomain_data=facet_domains) + ds(20, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(21, domain=mesh, subdomain_data=facet_domains) + ds(22, domain=mesh, subdomain_data=facet_domains) + ds(23, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(24, domain=mesh, subdomain_data=facet_domains) + ds(25, domain=mesh, subdomain_data=facet_domains) + ds(26, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(27, domain=mesh, subdomain_data=facet_domains) + ds(28, domain=mesh, subdomain_data=facet_domains) + ds(29, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(30, domain=mesh, subdomain_data=facet_domains) + ds(31, domain=mesh, subdomain_data=facet_domains) + ds(32, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(33, domain=mesh, subdomain_data=facet_domains) )   )
         ...
         K = lhs( nu*inner(grad(u), grad(v)) * dx - 2.0*beta_backflow *  inner(v, ( dot(u_,n_normal) - abs( dot(u_,n_normal) ) )/2. * u ) * (ds(3, domain=mesh, subdomain_data=facet_domains) + ds(4, domain=mesh, subdomain_data=facet_domains) + ds(5, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(6, domain=mesh, subdomain_data=facet_domains) + ds(7, domain=mesh, subdomain_data=facet_domains) + ds(8, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(9, domain=mesh, subdomain_data=facet_domains) + ds(10, domain=mesh, subdomain_data=facet_domains) + ds(11, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(12, domain=mesh, subdomain_data=facet_domains) + ds(13, domain=mesh, subdomain_data=facet_domains) + ds(14, domain=mesh, subdomain_data=facet_domains) \
                                                                                                                                                 + ds(15, domain=mesh, subdomain_data=facet_domains) + ds(16, domain=mesh, subdomain_data=facet_domains) + ds(17, domain=mesh, subdomain_data=facet_domains) \
...
def pressure_solve(Resistance_flag, Res_vec_tmp, Res1, Res2, Res3, Res4, Res5, Res6, Res7, Res8, Res9, Res10, Res11, Res12, Res13, Res14, Res15, Res16, Res17, Res18, Res19, Res20, Res21, Res22, Res23, Res24, Res25, Res26, Res27, Res28, Res29, Res30, Res31, tstep, Q,n_normal,facet_domains,mesh,assemble_matrix,u_,dp_, x_, Ap,Ap2, b, p_sol, bcs, **NS_namespace):
    """Solve pressure equation."""
    if (Resistance_flag and tstep>49):
         for i in xrange(31):
          if MPI.rank(mpi_comm_world()) == 0:
            print 'Res(',i,') = ', Res_vec_tmp[i] 
         # print 'Res1_initial = ', Res1, 'Res2_initial = ', Res2, 'Res3_initial = ', Res3
         # print 'Res4_initial = ', Res4, 'Res5_initial = ', Res5, 'Res6_initial = ', Res6
         # print 'Res7_initial = ', Res7, 'Res8_initial = ', Res8, 'Res9_initial = ', Res9
         # print 'Res10_initial = ', Res10, 'Res11_initial = ', Res11, 'Res12_initial = ', Res12
         # print 'Res13_initial = ', Res13, 'Res14_initial = ', Res14, 'Res15_initial = ', Res15
         # print 'Res16_initial = ', Res16, 'Res17_initial = ', Res17, 'Res18_initial = ', Res18
         # print 'Res19_initial = ', Res19, 'Res20_initial = ', Res20, 'Res21_initial = ', Res21
         # print 'Res22_initial = ', Res22, 'Res23_initial = ', Res23, 'Res24_initial = ', Res24
         # print 'Res25_initial = ', Res25, 'Res26_initial = ', Res26, 'Res27_initial = ', Res27
         # print 'Res28_initial = ', Res28, 'Res29_initial = ', Res29, 'Res30_initial = ', Res30
         # print 'Res31_initial = ', Res31


           #ds = Measure("ds")[facet_domains]
         ds = Measure("ds")(subdomain_data=facet_domains)
         flow_vec = numpy.zeros(31)
         for i in xrange(31):
            flow_vec[i] = abs( assemble(dot(u_, n_normal)*ds(i+3, domain=mesh, subdomain_data=facet_domains) ) )
         ...
         Res_bc1 =  flow1/Res_vec_tmp[0]  
         Res_bc2 =  flow2/Res_vec_tmp[1]
         Res_bc3 =  flow3/Res_vec_tmp[2]
         Res_bc4 =  flow4/Res_vec_tmp[3]
         Res_bc5 =  flow5/Res_vec_tmp[4]
         Res_bc6 =  flow6/Res_vec_tmp[5]
         Res_bc7 =  flow7/Res_vec_tmp[6]
         Res_bc8 =  flow8/Res_vec_tmp[7]
         Res_bc9 =  flow9/Res_vec_tmp[8]
         Res_bc10 =  flow10/Res_vec_tmp[9]
         Res_bc11 =  flow11/Res_vec_tmp[10]
         Res_bc12 =  flow12/Res_vec_tmp[11]
         Res_bc13 =  flow13/Res_vec_tmp[12]
         Res_bc14 =  flow14/Res_vec_tmp[13]
         Res_bc15 =  flow15/Res_vec_tmp[14]
         Res_bc16 =  flow16/Res_vec_tmp[15]
         Res_bc17 =  flow17/Res_vec_tmp[16]
         Res_bc18 =  flow18/Res_vec_tmp[17]
         Res_bc19 =  flow19/Res_vec_tmp[18]
         Res_bc20 =  flow20/Res_vec_tmp[19]
         Res_bc21 =  flow21/Res_vec_tmp[20]
         Res_bc22 =  flow22/Res_vec_tmp[21]
         Res_bc23 =  flow23/Res_vec_tmp[22]
         Res_bc24 =  flow24/Res_vec_tmp[23]
         Res_bc25 =  flow25/Res_vec_tmp[24]
         Res_bc26 =  flow26/Res_vec_tmp[25]
         Res_bc27 =  flow27/Res_vec_tmp[26]
         Res_bc28 =  flow28/Res_vec_tmp[27]
         Res_bc29 =  flow29/Res_vec_tmp[28]
         Res_bc30 =  flow30/Res_vec_tmp[29]
         Res_bc31 =  flow31/Res_vec_tmp[30]
