...
def pressure_solve(Resistance_flag,Res1, Res2, Res3, tstep, Q,n_normal,facet_domains,mesh,assemble_matrix,u_,dp_, x_, Ap,Ap2, b, p_sol, bcs, **NS_namespace):
...
#                print 'Res1 has changed!'
     ...
     if MPI.rank(mpi_comm_world()) == 0:
        ...
        print '+++++++++++++++++++++++ Res_bc: total outflow:', flow1 + flow2 + flow3
        print '+++++++++++++++++++++++ inlet_bc: inflow:', inflow
        print '+++++++++++++++++++++++ Res1 = ', Res1, 'Res2 = ', Res2, 'Res3 =', Res3
     bcs['p'] = [DirichletBC(Q,  Res_bc1 , facet_domains,3), DirichletBC(Q,  Res_bc2, facet_domains,4), DirichletBC(Q,  Res_bc3, facet_domains,5)]
       #Ap = assemble_matrix(Ap2, bcs['p'])
