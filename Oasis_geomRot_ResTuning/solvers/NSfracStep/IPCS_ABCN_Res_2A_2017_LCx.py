...
def pressure_solve(Resistance_flag,Res1, Res2, tstep, Q,n_normal,facet_domains,mesh,assemble_matrix,u_,dp_, x_, Ap,Ap2, b, p_sol, bcs, **NS_namespace):
    """Solve pressure equation."""
    if (Resistance_flag and tstep>20):
     if MPI.rank(mpi_comm_world()) == 0:
         print 'Res1_initial = ', Res1, 'Res2_initial = ', Res2
...
#                print 'Res1 has changed!'
     ...
     if MPI.rank(mpi_comm_world()) == 0:
        ...
        print '+++++++++++++++++++++++ Res_bc: total outflow:', flow1 + flow2 
