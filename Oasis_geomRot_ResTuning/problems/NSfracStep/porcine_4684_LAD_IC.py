...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/transport/porcines/4684_D/mesh/4684_LAD_baseline.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_IC_Porcine_4684_LAD",
            nu=0.04/(1.06),
            T=  0.674*3,
            dt= 0.674 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/transport/porcines/4684_D/Results_IC',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res1 = 0.0, #resistance at the first outlet
            Res2 = 1527.58, #resistance at the second outlet
            Res3 = 6278.29, #resistance at the third outlet
            Res4 = 2836.31, #resistance at the fourth outlet
            Res5 = 6796.38, #resistance at the fourth outlet
            Res6 = 727.6188, #resistance at the fourth outlet
...
def create_bcs(t,t_cycle,Time_array,v_IR_array, V, Q, facet_domains, mesh, **NS_namespace):
    ...
    return dict(u0=[bc_in_1, bc_wall_1],
                ...
                p=[bcp1, bcp2, bcp3, bcp4, bcp5, bcp6])
    #return dict(u0=[bc_in_1, bc_wall_1],
    #           u1=[bc_in_2, bc_wall_2],
    #           u2=[bc_in_3, bc_wall_3],
    #           p =[]) # no pressure BC
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = porcine_4684_LAD_BC.time_BC()
    v_IR_array = porcine_4684_LAD_BC.Vel_IR_BC()
