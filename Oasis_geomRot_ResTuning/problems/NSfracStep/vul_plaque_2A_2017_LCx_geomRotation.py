...
import vul_plaque_2A_2017_LCx_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/2A_2017/LCx/mesh/2A_2017_LCx.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_2A_2017_LCx",
            nu=0.04/(1.06),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/oasis_geometries/2A_2017/LCx/Results',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res2 = 16926.2921, #resistance at the second outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_2A_2017_LCx_BC.time_BC()
    v_IR_array = vul_plaque_2A_2017_LCx_BC.Vel_IR_BC()
