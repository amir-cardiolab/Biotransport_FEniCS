...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/utilities/BC_xml/1A_2012_LAD_mesh.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            nu=0.004/(1.06/1000),
            T=  1.0*3,
            dt= 1.0 /(2000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/1st_order_mesh/data',
            velocity_degree=1,
            save_step= 40 * 5, #40 * 5
            save_start= 5000,
            checkpoint=100*1e9,
...
def create_bcs(t,t_cycle,Time_array,v_IR_array, V, Q, mesh, **NS_namespace):
    ...
    bc_file =  '/scratch/mm4238/utilities/BC_xml/BCnodeFacets.xml'
