...
import vul_plaque_35A_2017_LAD_SS_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/35A_2017/LAD/mesh/35A_2017_LAD.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_35A_2017_LAD",
            nu=0.04/(1.06),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/oasis_geometries/35A_2017/LAD/Results',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 40000,
            checkpoint=100*1e9,
            ...
            Res3 = 1e-2, #resistance at the third outlet
            Res4 = 1e-2, #resistance at the third outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_35A_2017_LAD_SS_BC.time_BC()
    v_IR_array = vul_plaque_35A_2017_LAD_SS_BC.Vel_IR_BC()
