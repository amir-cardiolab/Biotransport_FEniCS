...
import vul_plaque_1A20121206_LAD_BC
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            Res1 = 400.97, #resistance at the first outlet
            Res2 = 7.68e-05, #resistance at the second outlet
            Res3 = 87.43, #resistance at the third outlet
...
def create_bcs(t,t_cycle,Time_array,v_IR_array, V, Q, facet_domains, mesh, **NS_namespace):
    ...
    if (parabolic_flag):
      ...
      bc_u2 = Expression("n0 * u * (1 - (pow(cent0-x[0], 2) + pow(cent1-x[1], 2) ) / r)",n0=normal[2], r=inlet_radius2, u=-2.0*v_inlet_BC*1000, cent0=center[0],cent1=center[1],cent2=center[2], degree=3)
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_1A20121206_LAD_BC.time_BC()
    v_IR_array = vul_plaque_1A20121206_LAD_BC.Vel_IR_BC()
