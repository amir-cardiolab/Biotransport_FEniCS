...
import vul_plaque_3A_2016_LCx_BC
#import vul_plaque_LCx_SS_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/3A_2016/LCx/3A_2016_LCx.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            folder= '/scratch/mm4238/oasis_geometries/3A_2016/LCx/Results',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res1 = 966.139980, #resistance at the first outlet
            Res2 = 4665.97311, #resistance at the second outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_3A_2016_LCx_BC.time_BC()
    v_IR_array = vul_plaque_3A_2016_LCx_BC.Vel_IR_BC()
