...
def mesh(**params):
    ...
    m = Mesh('/home/mm4238/vul_plaque_project/biochem_tr_Budof/1A_2012_LAD/cylinder_mesh.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            folder= '/home/mm4238/vul_plaque_project/biochem_tr_Budof/1A_2012_LAD',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 0.95*2,
            checkpoint=100*1e9,
...
def pre_solve_hook(mesh, velocity_degree, u_,
    ...
    Time_array = cylinder_test_BC.time_BC()
    v_IR_array = cylinder_test_BC.Vel_IR_BC()
