...
import vul_plaque_10A_2016_LCx_SS_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/10A_2016/LCx/mesh/10A_2016_LCx.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_10A_2016_LCx",
            nu=0.04/(1.06),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/oasis_geometries/10A_2016/LCx/Results',
            velocity_degree=2,
            save_step= 1, #40 * 5
            save_start= 1,
            checkpoint=100*1e9,
            ...
            Res1 = 1e-2, #resistance at the first outlet
            Res2 = 1e-2, #resistance at the second outlet
            Res3 = 1e-2, #resistance at the second outlet
            Res4 = 1e-2, #resistance at the second outlet
            Res5 = 1e-2, #resistance at the second outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_10A_2016_LCx_SS_BC.time_BC()
    v_IR_array = vul_plaque_10A_2016_LCx_SS_BC.Vel_IR_BC()
