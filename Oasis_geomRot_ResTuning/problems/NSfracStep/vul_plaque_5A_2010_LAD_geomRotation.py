...
import vul_plaque_5A_2010_LAD_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/5A_2010/LAD/mesh/5A_2010_LAD.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_5A_2010_LAD",
            nu=0.04/(1.06),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/oasis_geometries/5A_2010/LAD/Results',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res1 = 9.7e-8, #resistance at the first outlet
            Res2 = 1609.1349, #resistance at the second outlet
            Res3 = 2364.5875, #resistance at the third outlet
            Res4 = 946.7243, #resistance at the fourth outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_5A_2010_LAD_BC.time_BC()
    v_IR_array = vul_plaque_5A_2010_LAD_BC.Vel_IR_BC()
