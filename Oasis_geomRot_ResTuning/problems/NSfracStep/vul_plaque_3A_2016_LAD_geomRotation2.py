...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/3A_2016/LAD/3A_2016_LAD.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            ...
            folder= '/scratch/mm4238/oasis_geometries/3A_2016/LAD/Results2',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res1 = 2583.65798, #resistance at the first outlet
            Res2 = 1283.1333, #resistance at the second outlet
            Res3 = 0.0, #resistance at the third outlet
            Res4 = 2677.4054, #resistance at the fourth outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_3A_2016_LAD_BC.time_BC()
    v_IR_array = vul_plaque_3A_2016_LAD_BC.Vel_IR_BC()
