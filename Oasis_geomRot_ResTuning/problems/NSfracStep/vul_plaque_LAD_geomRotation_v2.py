...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/utilities/LAD_mesh/1A_2012_LAD.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_LAD",
            nu=0.004/(1.06/1000),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/utilities/LAD_mesh',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res1 = 444.179, #resistance at the first outlet
            Res2 = 596.338, #resistance at the second outlet
            Res3 = 0.0, #resistance at the third outlet
            Res4 = 1218.938, #resistance at the fourth outlet
