...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_prostate_artery_cropped",
            nu=0.004/(1.06/1000),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(4000.*10.)
            folder= '/scratch/mm4238/prostate_CFD/oasis_Results',
            velocity_degree=1,
            save_step= 20 * 5, #40 * 5
            save_start= 1,
            checkpoint=100*1e9,
...
def create_bcs(t,t_cycle,Time_array,v_IR_array, V, Q, facet_domains, mesh, **NS_namespace):
    ...
    return dict(u0=[bc_in_1, bc_wall_1],
                ...
                p=[bcp1, bcp2, bcp3, bcp4, bcp5, bcp6, bcp7, bcp8, bcp9, bcp10, bcp11, bcp12, bcp13, bcp14, bcp15, bcp16, bcp17, bcp18, bcp19, bcp20, bcp21, bcp22, bcp23, bcp24, bcp25])
    #return dict(u0=[bc_in_1, bc_wall_1],
    #           u1=[bc_in_2, bc_wall_2],
    #           u2=[bc_in_3, bc_wall_3],
    #           p =[]) # no pressure BC
