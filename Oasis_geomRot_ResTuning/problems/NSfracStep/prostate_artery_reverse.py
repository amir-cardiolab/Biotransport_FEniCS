...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/prostate_CFD/cropped_mesh/prostate_arteries.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_prostate_artery_reverse",
            nu=0.004/(1.06/1000),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(4000.*10.)
            folder= '/scratch/mm4238/prostate_CFD/oasis_Results/reverse',
            velocity_degree=1,
            save_step= 20 * 5, #40 * 5
            save_start= 1,
            checkpoint=100*1e9,
            ...
            beta_backflow = 2. , # btwn 0 and 1 (actually beta=2.0 and higher works!)
            ...
            Res1 = 1.0e-4, #resistance at the first outlet
            Res2 = 1.0e-4, #resistance at the second outlet
            Res3 = 1.0e-4, #resistance at the third outlet
            Res4 = 1.0e-4, #resistance at the fourth outlet
            Res5 = 1.0e-4, #resistance at the fourth outlet
            Res6 = 1.0e-4, #resistance at the fourth outlet
            Res7 = 1.0e-4, #resistance at the fourth outlet
            Res8 = 1.0e-4, #resistance at the fourth outlet
            Res9 = 1.0e-4, #resistance at the fourth outlet
            Res10 = 1.0e-4, #resistance at the first outlet
            Res11 = 1.0e-4, #resistance at the second outlet
            Res12 = 1.0e-4, #resistance at the third outlet
            Res13 = 1.0e-4, #resistance at the fourth outlet
            Res14 = 1.0e-4, #resistance at the fourth outlet
            Res15 = 1.0e-4, #resistance at the fourth outlet
            Res16 = 1.0e-4, #resistance at the fourth outlet
            Res17 = 1.0e-4, #resistance at the fourth outlet
            Res18 = 1.0e-4, #resistance at the fourth outlet
            Res19 = 1.0e-4, #resistance at the first outlet
            Res20 = 1.0e-4, #resistance at the second outlet
            Res21 = 1.0e-4, #resistance at the third outlet
            Res22 = 1.0e-4, #resistance at the fourth outlet
            Res23 = 0.0, #resistance at the fourth outlet
            Res24 = 0.0, #resistance at the fourth outlet
            Res25 = 1.0e-4, #resistance at the fourth outlet
...
def create_bcs(t,t_cycle,Time_array,v_IR_array, V, Q, n_normal_x, n_normal_y, n_normal_z, A, facet_domains, mesh, **NS_namespace):
    ...
    #*********************** Dirichlet Boundary Conditions for Outlets ***********************
    ...
    if (inlet_flag_flow):
        v_inlet_BC = v_inlet_BC*1e3

    inflow = Expression('-vel_IR',vel_IR=0,degree=3)
    inflow.vel_IR = v_inlet_BC

    bc_in_1 = numpy.zeros(25)
    bc_in_2 = numpy.zeros(25)
    bc_in_3 = numpy.zeros(25)

    for i in xrange(25):
        bc_in_1[i]  = DirichletBC(V, n_normal_x[i] * inflow / A[i] * target_ratios[i] , facet_domains, i+3) #inlet for u_x
        bc_in_2[i]  = DirichletBC(V, n_normal_y[i] * inflow / A[i] * target_ratios[i] , facet_domains, i+3) #inlet for u_y
        bc_in_3[i]  = DirichletBC(V, n_normal_z[i] * inflow / A[i] * target_ratios[i] , facet_domains, i+3) #inlet for u_z

    bcp1  = DirichletBC(Q, 0. , facet_domains,inlet_facet_ID) #outlet p


    if MPI.rank(mpi_comm_world()) == 0:
      print '-----t = ', t
      print '-----t_cycle = ', t_cycle
    return dict(u0=[bc_in_1[0], bc_in_1[1], bc_in_1[2], bc_in_1[3], bc_in_1[4], bc_in_1[5], bc_in_1[6], bc_in_1[7], bc_in_1[8], bc_in_1[9], bc_in_1[10], bc_in_1[11], bc_in_1[12], bc_in_1[13], bc_in_1[14], bc_in_1[15], bc_in_1[16], bc_in_1[17], bc_in_1[18], bc_in_1[19], bc_in_1[20], bc_in_1[21], bc_in_1[22], bc_in_1[23], bc_in_1[24], bc_wall_1],
                u1=[bc_in_2[0], bc_in_2[1], bc_in_2[2], bc_in_2[3], bc_in_2[4], bc_in_2[5], bc_in_2[6], bc_in_2[7], bc_in_2[8], bc_in_2[9], bc_in_2[10], bc_in_2[11], bc_in_2[12], bc_in_2[13], bc_in_2[14], bc_in_2[15], bc_in_2[16], bc_in_2[17], bc_in_2[18], bc_in_2[19], bc_in_2[20], bc_in_2[21], bc_in_2[22], bc_in_2[23], bc_in_2[24], bc_wall_2],
                u2=[bc_in_3[0], bc_in_3[1], bc_in_3[2], bc_in_3[3], bc_in_3[4], bc_in_3[5], bc_in_3[6], bc_in_3[7], bc_in_3[8], bc_in_3[9], bc_in_3[10], bc_in_3[11], bc_in_3[12], bc_in_3[13], bc_in_3[14], bc_in_3[15], bc_in_3[16], bc_in_3[17], bc_in_3[18], bc_in_3[19], bc_in_3[20], bc_in_3[21], bc_in_3[22], bc_in_3[23], bc_in_3[24], bc_wall_3],
                p=[bcp1])
