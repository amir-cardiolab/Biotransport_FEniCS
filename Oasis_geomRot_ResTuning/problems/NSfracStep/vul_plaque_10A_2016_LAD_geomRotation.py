...
import vul_plaque_10A_2016_LAD_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/10A_2016/LAD/mesh/10A_2016_LAD.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_10A_2016_LAD",
            nu=0.04/(1.06),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 1.0 /(4000.*5.)
            folder= '/scratch/mm4238/oasis_geometries/10A_2016/LAD/Results',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 40000,
            checkpoint=100*1e9,
            ...
            Res1 = 1.0, #resistance at the first outlet
            Res2 = 7300.8577, #resistance at the second outlet
            Res3 = 5.2885, #resistance at the third outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_10A_2016_LAD_BC.time_BC()
    v_IR_array = vul_plaque_10A_2016_LAD_BC.Vel_IR_BC()
