...
import vul_plaque_4A_2016_LAD_BC
#import vul_plaque_4A_2016_LAD_SS_BC
...
def mesh(**params):
    ...
    m = Mesh('/scratch/mm4238/oasis_geometries/4A_2016/LAD/mesh/4A_2016_LAD.xml')
    return m
...
if restart_folder:
        ...
        NS_parameters.update(
            solver="IPCS_ABCN_Res_A4_2016_LAD",
            nu=0.04/(1.06),
            T=  1.0*3,
            dt= 1.0 /(4000. * 5.) , # 0.95 /(2000.*5.)
            folder= '/scratch/mm4238/oasis_geometries/4A_2016/LAD/Results',
            velocity_degree=2,
            save_step= 40 * 5, #40 * 5
            save_start= 2000,
            checkpoint=100*1e9,
            ...
            Res1 = 823.2932, #resistance at the first outlet
            Res2 = 0.0, #resistance at the second outlet
            Res3 = 1035.2219, #resistance at the third outlet
            Res4 = 1671.4301, #resistance at the fourth outlet
...
def pre_solve_hook(mesh, facet_domains, velocity_degree, u_,
    ...
    Time_array = vul_plaque_4A_2016_LAD_BC.time_BC()
    v_IR_array = vul_plaque_4A_2016_LAD_BC.Vel_IR_BC()
