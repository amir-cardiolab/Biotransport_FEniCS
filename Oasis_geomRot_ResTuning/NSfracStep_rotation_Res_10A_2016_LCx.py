...
bc_file =  '/scratch/mm4238/oasis_geometries/10A_2016/LCx/mesh/BCnodeFacets.xml'
    ...
    while udiff[0] > max_error and inner_iter < num_iter:
        ...
        if (Resistance_flag):
         ...
         if (tstep > 20 and tstep%10==0):
           ...
           ratios = numpy.zeros(5)
           current_ratios = numpy.zeros(5)
           ratios_threshold = numpy.zeros(5)
           target_ratios = [0.313055, 0.118253, 0.167556, 0.208505, 0.192631]
