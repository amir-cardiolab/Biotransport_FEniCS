...
bc_file =  '/scratch/mm4238/prostate_CFD/mesh_files/BCnodeFacets.xml'
...
#Rotating the mesh so that the average normal vector aligned with z-axis passing the centroid
      ...
      mesh.rotate(alpha_ang, 1, center)
    ...
    while udiff[0] > max_error and inner_iter < num_iter:
        ...
        if (Resistance_flag):
         ...
         if tstep > 100 and tstep % 10 == 0:
           ...
           target_ratios = [0.0111, 0.1013, 0.0256, 0.0256, 0.0523, 0.1279, 0.0259, 0.018, 0.0103, 0.0063, 0.0091, 0.032, 0.0482, 0.0087, 0.0068, 0.0063, 0.0266, 0.0272, 0.0602, 0.0602, 0.0645, 0.1017, 0.0049, 0.0049, 0.0111, 0.0149, 0.0539, 0.0061, 0.0103, 0.0061, 0.032]
         ...
         if MPI.rank(mpi_comm_world()) == 0:
               ...
               print 'Res19 = ', Res19, 'Res20 = ', Res20, 'Res21 = ', Res21, 'Res22 = ', Res22, 'Res23 = ', Res23, 'Res24 = ', Res24, 'Res25 = ', Res25, 'Res26 = ', Res26, 'Res27 = ', Res27
               print 'Res28 = ', Res28, 'Res29 = ', Res29, 'Res30 = ', Res30, 'Res31 = ', Res31
