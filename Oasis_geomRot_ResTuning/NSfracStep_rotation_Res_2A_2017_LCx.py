...
bc_file =  '/scratch/mm4238/oasis_geometries/2A_2017/LCx/mesh/BCnodeFacets.xml'
    ...
    while udiff[0] > max_error and inner_iter < num_iter:
        ...
        if (Resistance_flag):
         ...
         if tstep > 20:
           ...
           ratios = numpy.zeros(2)
           current_ratios = numpy.zeros(2)
           ratios_threshold = numpy.zeros(2)
           target_ratios = [0.89711, 0.10289]
